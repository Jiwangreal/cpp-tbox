...
TEST(Serializer, big_endian_raw) {
  uint8_t data_to_be[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x11, 0x12,
                          0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x21, 0x22};
...
TEST(Serializer, little_endian) {
  const uint8_t data_to_be[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
                                0x07, 0x11, 0x12, 0x13, 0x14, 0x15,
                                0x16, 0x17, 0x18, 0x21, 0x22};
  uint8_t data_be_write[sizeof(data_to_be)] = {0x00};
...
TEST(Deserializer, big_endian) {
  uint8_t data_be_read[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                            0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                            0x18, 0x21, 0x22, 0x23, 0x24};
...
TEST(SerializerDeserialize, big_endian) {
  ...
  s << int8_t(-1) << uint8_t(2) << int16_t(-3) << uint16_t(4) << int32_t(-5)
    << uint32_t(6) << int64_t(-7) << uint64_t(8) << float(1.0) << double(12.3);
